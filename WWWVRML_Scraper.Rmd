---
title: "WWWVRML_SCRAPER_Webhistory.org"
...
Problematic_time <- Time[index_problematic, ]%>%
...
ggplot(Timeline, aes(x = Date_Ym, y = Tot_Month)) +
  geom_bar(stat = "identity") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) + 
  geom_text(aes(label = Tot_Month), vjust = -0.3, size=3)+#
  xlab("Timeline (Y-m)") +
  ylab("Numero di Messaggi") +
  ggtitle("Totale Mensile dei Messaggi") +
  scale_x_discrete(limits = Timeline$Date_Ym)
